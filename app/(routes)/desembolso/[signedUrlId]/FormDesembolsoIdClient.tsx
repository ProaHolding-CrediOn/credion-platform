            ...
            <main className="flex w-full flex-1 items-start justify-center px-4 py-8 sm:px-6 md:px-8">
                ...
                {!showForm && !loading ? (
                    <div className="bg-card sm:bg-card sm:rounded-lg sm:shadow-md p-4 md:p-6 w-full space-y-4">
                        ...
                        <h2 className="text-base md:text-lg text-center font-light text-foreground">¡Tienes un Pre Aprobado de <span className="font-semibold">${formatPrice(disbursementAmount || 0)} COP</span>!</h2>
                        <h2 className="text-sm md:text-base text-center font-light text-muted-foreground">Luego de deducciones, tendrás un desembolso de <span className="font-semibold">${formatPrice(approvedAmount || 0)} COP</span></h2>
                    ...
                    <main className="flex w-full flex-1 items-start justify-center sm:px-6 md:px-8">
                        <div className="w-full max-w-2xl space-y-6">
                            <div className="flex flex-col items-center">
                                ...
                                <Label className="text-muted-foreground text-sm mt-2">Formulario de Desembolso F-AC-08</Label>
                            </div>
                            <FormRenderer
                                steps={steps}
