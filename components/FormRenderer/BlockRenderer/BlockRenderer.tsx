...
import { ConditionalFormBlock, EnhancedBlock, EnhancedField, FormBlock, PayoutDistributionBlock, RepeatableFormBlock } from "@/types/FormField";
...
export const isPayoutDistributionBlock = (field: EnhancedBlock): field is PayoutDistributionBlock => {
...
export default function BlockRenderer({
  ...
  if (isPayoutDistributionBlock(block)) {
